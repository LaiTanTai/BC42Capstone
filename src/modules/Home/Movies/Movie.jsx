                ...
                return <div className='col-lg-3 col-md-4 col-sm-6'>
                      <div className="card mb-2">
                        ...
                        <div className='card-body'>
                          ...
                          <button className='card-button' data-bs-toggle="modal" data-bs-target={"#exampleModalCenter" + item.maPhim}>Chi tiết</button>
                          <div className="modal fade" id={"exampleModalCenter" + item.maPhim} tabIndex={item.maPhim} aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
                            <div className="modal-dialog modal-dialog-centered">
                              <div className="modal-content background-video">
                                <div className="modal-body">
                                  ...
                                  <iframe className='w-100' height="300" src={item.trailer}></iframe>
                                </div>
                              </div>
                            </div>
                          </div>
